...
/* 함수 목적: ncurses 종료 및 정리 작업을 수행합니다.
 * 매개변수: 없음
 * 반환 값: 없음
 */
...
/* 함수 목적: message를 상태 표시줄에 그리는 역할을 한다.
 * 매개변수: message
 * 반환 값: 없음
 */
...
/* 함수 목적: 숫자 입력 프롬프트를 표시하고 결과를 반환합니다.
